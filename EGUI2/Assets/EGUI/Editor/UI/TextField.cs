...
namespace EGUI.UI
{
    ...
    {
        private static Color TextSelectionColor = new Color(0.2392157f, 0.5019608f, 0.8745099f, 0.65f);
        private static Color TextCursorColor = new Color(0.7058824f, 0.7058824f, 0.7058824f, 1f);

        [PersistentField]
        private Color mSelectionColor = TextSelectionColor;

        public Color selectionColor { get { return mSelectionColor; } set { mSelectionColor = value; } }

        [PersistentField]
        private Color mCursorColor = TextCursorColor;

        public Color cursorColor { get { return mCursorColor; } set { mCursorColor = value; } }

        [PersistentField]
        private Color mDisabledColor = Color.grey;
        ...
        public bool multiline { get { return mMultiline; } set { mMultiline = value; } }

        [PersistentField]
        private bool mPassword;

        public bool password { get { return mPassword; } set { mPassword = value; } }

        [PersistentField]
        private bool mFocused;

        public bool focused { get { return mFocused; } set { if (mFocused != value) { mFocused = value; if (!mFocused) OnDeselect(); } } }

        [PersistentField]
        private bool mInteractive = true;

        public bool interactive { get { return mInteractive; } set { mInteractive = value; } }
        ...
        public void OnEvent(Event eventData)
        {
            ...
            if (!isEditingBeforce && isEditingAfter)
            {
